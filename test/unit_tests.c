...
static void test_ring_buffer_threaded(void) {
    ...
    ok_or_panic(soundio_os_thread_create(reader_thread_run, NULL, NULL, NULL, &reader_thread));

    struct SoundIoOsThread *writer_thread;
    ok_or_panic(soundio_os_thread_create(writer_thread_run, NULL, NULL, NULL, &writer_thread));
